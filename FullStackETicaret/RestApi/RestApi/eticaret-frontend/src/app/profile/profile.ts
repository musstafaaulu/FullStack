...
export class ProfileComponent implements OnInit {
  ...
  changePassword() {
    this.passwordError = '';
    if (!this.passwordForm.current) { this.passwordError = 'Mevcut şifreyi gir'; return; }
    if (this.passwordForm.newPass.length < 6) { this.passwordError = 'Yeni şifre en az 6 karakter olmalı'; return; }
    if (this.passwordForm.newPass !== this.passwordForm.confirm) { this.passwordError = 'Şifreler eşleşmiyor'; return; }
